<div>
    <x-wire-card>
        ...
        <p class="text-sm text-gray-500 mt-1">
            Complete la platilla con los datos de tus Almacenes y subelos aquí.
        </p>
            ...
            <div class="mt-4">
                ...
                <div class="p-4 bg-yellow-100 border border-yellow-300 rounded-md text-yellow-800 mb-3">
                    ...
                    @else
                        ...
                        <strong>No se Importo Ningún Almacén</strong>

                        <p class="mt-1 text-sm">
                            Todos los Almacenes tienen errores o el archivo es fallido.
                        </p>
                    @endif
                </div>
